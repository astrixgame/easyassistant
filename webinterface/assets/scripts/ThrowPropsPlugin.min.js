...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
		"use strict";
		_gsScope._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenLite", "easing.Ease", "utils.VelocityTracker"], function(r, S, b, T) {
			function N(e, t) {
			...
			function V(e, t, r, o, n, i) {
				...
				if (r = isNaN(r) ? l : r, o = isNaN(o) ? -l : o, "object" == typeof t) {
					if (s = !t.calculated && ("function" == typeof c ? c(t) : u(t, c, r, o, i)) || t, !t.calculated) {
						for (a in s) t[a] = s[a];
						t.calculated = !0
					}
					s = s[n]
			...
			var _, w, C, P, l = 999999999999999,
				...
				x = "ThrowPropsPlugin",
				B = String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
				...
				D = N.calculateChange = function(e, t, r, o) {
					return null == o && (o = .05), r * o * e / (t instanceof b ? t : t ? new b(t) : S.defaultEase).getRatio(o)
				},
				...
				s = N.calculateTweenDuration = function(e, t, r, o, n, i) {
					...
					var s, a, c, u, f, p, l, g, d, h, v, m, y, _ = 0,
						w = 9999999999,
						C = t.throwProps || t,
						P = t.ease instanceof b ? t.ease : t.ease ? new b(t.ease) : S.defaultEase,
						k = isNaN(C.checkpoint) ? .05 : Number(C.checkpoint),
						x = isNaN(C.resistance) ? N.defaultResistance : Number(C.resistance);
					if (C.linkedProps)
						for (m = C.linkedProps.split(","), v = {}, y = 0; y < m.length; y++)(a = C[s = m[y]]) && (c = 0 < (u = void 0 !== a.velocity && "number" == typeof a.velocity ? Number(a.velocity) || 0 : (d = d || T.getByTarget(e)) && d.isTrackingProp(s) ? d.getVelocity(s) : 0) * (f = isNaN(a.resistance) ? x : Number(a.resistance)) ? u / f : u / -f, p = "function" == typeof e[s] ? e[s.indexOf("set") || "function" != typeof e["get" + s.substr(3)] ? s : "get" + s.substr(3)]() : e[s] || 0, v[s] = p + D(u, P, c, k));
					for (s in C) "resistance" !== s && "checkpoint" !== s && "preventOvershoot" !== s && "linkedProps" !== s && "radius" !== s && ("object" != typeof(a = C[s]) && ((d = d || T.getByTarget(e)) && d.isTrackingProp(s) ? a = "number" == typeof a ? {
						velocity: a
					} : {
						velocity: d.getVelocity(s)
					} : c = 0 < (u = Number(a) || 0) * x ? u / x : u / -x), "object" == typeof a && (c = 0 < (u = void 0 !== a.velocity && "number" == typeof a.velocity ? Number(a.velocity) || 0 : (d = d || T.getByTarget(e)) && d.isTrackingProp(s) ? d.getVelocity(s) : 0) * (f = isNaN(a.resistance) ? x : Number(a.resistance)) ? u / f : u / -f, l = (p = "function" == typeof e[s] ? e[s.indexOf("set") || "function" != typeof e["get" + s.substr(3)] ? s : "get" + s.substr(3)]() : e[s] || 0) + D(u, P, c, k), void 0 !== a.end && (a = V(a, v && s in v ? v : l, a.max, a.min, s, C.radius), (i || R) && (C[s] = O(a, C[s], "end"))), void 0 !== a.max && l > Number(a.max) + 1e-10 ? (h = a.unitFactor || N.defaultUnitFactors[s] || 1, (g = p > a.max && a.min !== a.max || -15 < u * h && u * h < 45 ? o + .1 * (r - o) : E(p, a.max, u, P, k)) + n < w && (w = g + n)) : void 0 !== a.min && l < Number(a.min) - 1e-10 && (h = a.unitFactor || N.defaultUnitFactors[s] || 1, (g = p < a.min && a.min !== a.max || -45 < u * h && u * h < 15 ? o + .1 * (r - o) : E(p, a.min, u, P, k)) + n < w && (w = g + n)), _ < g && (_ = g)), _ < c && (_ = c));
			...
			return (e.constructor = N).version = "0.11.0", N.API = 2, N._autoCSS = !0, N.defaultResistance = 100, N.defaultUnitFactors = {
				...
				var e, v, m, y, t = o.com.greensock.plugins.CSSPlugin;
				t && (e = t._internals, v = e._parseToProxy, m = e._setPluginRatio, y = e.CSSPropTween, e._registerComplexSpecialProp("throwProps", {
				...
				t.throwProps || (t = {
					throwProps: t
				}), 0 === n && (t.throwProps.preventOvershoot = !0), R = !0;
				var i = new S(e, o || 1, t);
				return i.render(0, !0, !0), R = (i.vars.css ? (i.duration(s(_, {
					throwProps: w,
					ease: t.ease
				}, r, o, n)), i._delay && !i.vars.immediateRender ? i.invalidate() : C._onInitTween(_, P, i)) : (i.kill(), i = new S(e, s(e, t, r, o, n), t)), !1), i
				...
				for (n in t)
					if ("resistance" !== n && "checkpoint" !== n && "preventOvershoot" !== n && "linkedProps" !== n && "radius" !== n) {
						...
						u = D(c, v, y, m), p = 0, s = (a = "function" == typeof e[n]) ? e[n.indexOf("set") || "function" != typeof e["get" + n.substr(3)] ? n : "get" + n.substr(3)]() : e[n], "object" == typeof i && (f = s + u, void 0 !== i.end && (i = V(i, g && n in g ? g : f, i.max, i.min, n, t.radius), R && (t[n] = O(i, t[n], "end"))), void 0 !== i.max && Number(i.max) < f ? _ || i.preventOvershoot ? u = i.max - s : p = i.max - s - u : void 0 !== i.min && Number(i.min) > f && (_ || i.preventOvershoot ? u = i.min - s : p = i.min - s - u)), this._overwriteProps[w] = n, this._props[w++] = {
							p: n,
							s: s,
							c1: u,
							c2: p,
			...
			function a(e, t, r) {
				...
				return o || 0 === o ? o : (e.style[t] ? o = e.style[t] : (r = r || g(e, null)) ? o = r[t] || r.getPropertyValue(t) || r.getPropertyValue(t.replace(f, "-$1").toLowerCase()) : e.currentStyle && (o = e.currentStyle[t]), parseFloat(o) || 0)
			}

			function c(e, t, r) {
				this.p = e, this.f = t, this.v1 = this.v2 = 0, this.t1 = this.t2 = d.time, this.css = !1, this.type = "", this._prev = null, r && ((this._next = r)._prev = this)
			}
			...
			function t() {
				...
				if (.03 <= o - n)
					for (n = o; r;) {
						for (t = r._firstVP; t;)((e = t.css ? a(r.target, t.p) : t.f ? r.target[t.p]() : r.target[t.p]) !== t.v1 || .15 < o - t.t1) && (t.v2 = t.v1, t.v1 = e, t.t2 = t.t1, t.t1 = o), t = t._next;
						r = r._next
					}
			}

			function u(e) {
				this._lookup = {}, this.target = e, this.elem = !(!e.style || !e.nodeType), r || (d.addEventListener("tick", t, null, !1, -100), n = d.time, r = !0), i && ((this._next = i)._prev = this), i = this
			}
			var i, r, n, f = /([A-Z])/g,
				p = {},
				l = {
			...
			return e.addProp = function(e, t) {
				var r, o, n, i;
				this._lookup[e] || (n = (o = "function" == typeof(r = this.target)[e]) ? this._altProp(e) : e, i = this._firstVP, this._firstVP = this._lookup[e] = this._lookup[n] = i = new c(n !== e && 0 === e.indexOf("set") ? n : e, o, i), i.css = this.elem && (void 0 !== this.target.style[i.p] || l[i.p]), i.css && l[i.p] && !r._gsTransform && s.set(r, {
					x: "+=0",
					overwrite: !1
				}), i.type = t || i.css && 0 === e.indexOf("rotation") ? "deg" : "", i.v1 = i.v2 = i.css ? a(r, i.p) : o ? r[i.p]() : r[i.p])
				...
				return t = (o.css ? a(n, o.p) : o.f ? n[o.p]() : n[o.p]) - o.v2, "rad" !== o.type && "deg" !== o.type || (t %= r = "rad" === o.type ? 2 * Math.PI : 360) !== t % (r / 2) && (t = t < 0 ? t + r : t - r), t / (d.time - o.t2)
				...
				var o = h(e),
					n = t.split(","),
					i = n.length;
				for (r = (r || "").split(","), o = o || new u(e); - 1 < --i;) o.addProp(n[i], r[i] || r[0]);
				return o
